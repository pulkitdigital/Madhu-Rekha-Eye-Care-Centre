...
//     try {
//       const response = await axios.get(`${API_URL}/discharge-slips/discharge-ticket/${ticketId}`);
...
//   // Backend PDF Download - Same logic as AllTickets
...
//         `${API_URL}/discharge-slips/discharge-ticket/${ticket.ticketId}/pdf`,
//         {
//           responseType: "blob",
//           timeout: 30000,
//         },
...
//       link.href = url;
//       link.download = `DischargeTicket-${ticket.ticketId}-${ticket.patientName.replace(/\s+/g, "_")}.pdf`;
...
//         <h3 className="text-xl font-bold text-gray-800">Discharge Ticket Dashboard</h3>
//         <button
...
//           <h4 className="text-lg font-semibold text-gray-800">Recent Discharge Tickets</h4>
...
//                 <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Discharge Date</th>
...
//                     <td className="py-3 px-4 text-sm font-medium text-blue-600">{ticket.ticketId}</td>
//                     <td className="py-3 px-4 text-sm text-gray-800 font-medium">{ticket.patientName}</td>
//                     <td className="py-3 px-4 text-sm text-gray-600">{ticket.age}/{ticket.sex}</td>
...
//                     </td>
//                     <td className="py-3 px-4 text-sm text-gray-600">{ticket.dischargeDate || 'N/A'}</td>
...
//           <p className="text-2xl font-bold text-emerald-900">{stats.todayTickets}</p>
